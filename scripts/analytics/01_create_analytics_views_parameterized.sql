-- YouTube Analytics Project - Create Analytics Views with Environment Parameters
-- This script uses variables to support multiple environments

-- Set environment-specific variables
-- In production, these would be set by the deployment pipeline
SET ENV = 'DEV'; -- Options: DEV, TEST, PROD
SET DB_NAME = CONCAT('YOUTUBE_ANALYTICS_', $ENV);
SET WH_NAME = CONCAT('YOUTUBE_', $ENV, '_WH');

-- Use the environment-specific database and warehouse
